...
import { Plus, Package, Edit2, Trash2, Loader2, X, AlertCircle } from 'lucide-react';
...
export default function ProductsPage() {
  ...
  const handleSaveProduct = async (e: React.FormEvent) => {
    ...
    const payload: Partial<Product> = {
      ...
      discount_price: discountPrice.trim() ? discountPrice : null,
      stock: Number(stock),
      is_active: isActive,
    };
    ...
    try {
      ...
      alert('Failed to save product. Please verify price formats and stock.');
    } finally {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex">
      ...
      <main className="flex-1 ml-64">
        ...
        {/* Create / Edit Modal (Fix: Explicit dark text styling on inputs) */}
        {isModalOpen && (
